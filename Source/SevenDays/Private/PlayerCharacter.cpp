...
APlayerCharacter::APlayerCharacter()
{
	...
	{
		RifleMesh = RifleMeshAsset.Object;
	}

	static ConstructorHelpers::FObjectFinder<USkeletalMesh> PistolMeshAsset(TEXT("/Game/MilitaryWeapDark/Weapons/Pistols_B.Pistols_B"));
